...
***************************************************/	
	 ...
	 * guess.
	 * 
	 * @param source - An integer OurPairing (x,y) for where the amazon piece is
	 * @param player - 1 for White, 2 for Black
	 * @return - True if we reach an opponent, false otherwise.
	 * 
	 ***************************************************************************************/
	private void countReachableTiles(OurPair<Integer, Integer> source, int player, int[][] hasChecked){
	...
	public class ButtonListener implements ActionListener{
		...
		private void handleMove(){
			...
			if (player1Turn){
				...
				board.updateQueenPosition(fRow, fCol, tRow, tCol, WQUEEN);
				...
				board.updateQueenPosition(fRow, fCol, tRow, tCol, BQUEEN);
